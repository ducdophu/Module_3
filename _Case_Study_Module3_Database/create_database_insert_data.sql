...
-- Tạo database FuramaResort
create database FuramaResort;
use FuramaResort;

-- Tạo table1 `vi_tri` và insert into dữ liệu
create table vi_tri
(
...
-- Tạo table2 `trinh_do` và insert into dữ liệu
...
-- Tạo table3 `bo_phan` và insert into dữ liệu
...
-- Tạo table4 `nhan_vien` và insert into dữ liệu
...
-- Tạo table5 `loai_khach` và insert into dữ liệu
...
-- Tạo table6 `khach_hang` và insert into dữ liệu
...
-- Tạo table7 `kieu_thue` và insert into dữ liệu
...
-- Tạo table8 `loai_dich_vu` và insert into dữ liệu
...
-- Tạo table9 `dich_vu` và insert into dữ liệu
...
-- Tạo table10 `dich_vu_di_kem` và insert into dữ liệu
...
-- Tạo table11 `hop_dong` và insert into dữ liệu
...
-- Tạo table12 `hop_dong_chi_tiet` và insert into dữ liệu
